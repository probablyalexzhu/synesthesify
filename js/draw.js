...
function draw(song, coords){
    ...
    //energy -- draw the shapes --cricles,rectangles,lines
    ...
    switch(energy){
        ...
        case 2:
            for (let i = 0; i < shape_count; i++){
                ...
                ctx.rect(centeerx,centery,centerx+len,centery+width);
            }
            break;
        case 1:
            for (let i = 0; i < shape_count; i++){
                let firstx = randomNumber(section_size-2)+tl.x;
                let firsty = randomNumber(section_size-2) + tl.y;
                let secondx = randomNumber(section_size-2)+tl.x;
                let secondy = randomNumber(section_size-2)+tl.y;
                ctx.beginPath();
